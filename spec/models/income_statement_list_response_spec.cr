...
# Unit tests for ::IncomeStatementListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ::IncomeStatementListResponse do
  ...
  describe "test an instance of IncomeStatementListResponse" do
    it "should create an instance of IncomeStatementListResponse" do
      #instance = ::IncomeStatementListResponse.new
      #expect(instance).to be_instance_of(::IncomeStatementListResponse)
    end
  end
