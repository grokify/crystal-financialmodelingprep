...
module 
  class IncomeStatementListResponse
    ...
    # Optional properties
    @[JSON::Field(key: "data", type: Array(IncomeStatement)?, nillable: true, emit_null: false)]
    property data : Array(IncomeStatement)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@data : Array(IncomeStatement)?)
    end
