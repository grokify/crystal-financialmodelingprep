...
module Financialmodelingprep
  ...
  class IncomeStatement
    ...
    def hash
      [accepted_date, calendar_year, cik, cost_and_expenses, cost_of_revenue, date, depreciation_and_amortization, ebitda, ebitdaratio, eps, epsdiluted, filling_date, final_link, general_and_administrative_expenses, gross_profit, gross_profit_ratio, income_before_tax, income_before_tax_ratio, income_tax_expense, interest_expense, interest_income, interestincome, link, net_income, net_income_ratio, operating_expenses, operating_income, operating_income_ratio, other_expenses, period, reported_currency, research_and_development_expenses, revenue, selling_and_marketing_expenses, selling_general_and_administrative_expenses, symbol, total_other_income_expenses_net, weighted_average_shs_out, weighted_average_shs_out_dil].hash
    end
